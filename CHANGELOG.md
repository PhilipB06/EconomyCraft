...
- Added transaction logging: every balance change is written to a daily file, kept for a configurable number of days.
- Added an optional Discord-compatible webhook, configured through its own `webhook.json`.
